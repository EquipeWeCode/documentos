...
\newglossaryentry{sprint}{
	name={Sprint},
	plural={Sprints},
	description={Uma iteração de desenvolvimento, unidade de planejamento do \gls{scrum} na qual se verifica o trabalho (funcionalidade) a ser entregue, os recursos necessários e ocorre o desenvolvimento do software de fato.} 
}
