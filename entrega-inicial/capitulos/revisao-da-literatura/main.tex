...
% ----------------------------------------------------------
\input{capitulos/revisao-da-literatura/section-spa}

% ----------------------------------------------------------
% API REST
% ----------------------------------------------------------
\input{capitulos/revisao-da-literatura/section-api-rest}

% ----------------------------------------------------------
% ÁREAS DO CONHECIMENTO
% ----------------------------------------------------------
\input{capitulos/revisao-da-literatura/section-areas-conhecimento}
